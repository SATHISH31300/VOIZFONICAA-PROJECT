...
import { customerquery } from './models/customerquerys';
...
export class ServicesService {
  ...
  complain(Customerquery:customerquery):Observable<object>{
    console.log(Customerquery)
    return this.httpClient.post("http://localhost:8090/user/complain",Customerquery);
